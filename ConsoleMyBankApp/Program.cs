...
namespace ConsoleMyBankApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Titular: {0}", contaPoupança.getTitular().getNome());
            Console.WriteLine("Agencia: {0}", contaPoupança.getAgencia());
            Console.WriteLine("Conta: {0}", contaPoupança.getConta());
        }
    }
}
